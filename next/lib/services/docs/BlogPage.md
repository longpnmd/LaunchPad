...
**localizations** | [**Array&lt;BlogPageLocalizationsInner&gt;**](BlogPageLocalizationsInner.md) |  | [optional] [default to undefined]

## Example

```typescript
import { BlogPage } from './api';

const instance: BlogPage = {
    id,
    documentId,
    seo,
    heading,
