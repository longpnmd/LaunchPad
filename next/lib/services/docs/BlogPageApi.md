...
|------------- | ------------- | -------------|
|[**deleteBlogPage**](#deleteblogpage) | **DELETE** /blog-page | |
|[**getBlogPage**](#getblogpage) | **GET** /blog-page | |
|[**putBlogPage**](#putblogpage) | **PUT** /blog-page | |

# **deleteBlogPage**
> number deleteBlogPage()
...
const { status, data } = await apiInstance.deleteBlogPage();
```
...
const { status, data } = await apiInstance.getBlogPage(
    sort,
    paginationWithCount,
    paginationPage,
    paginationPageSize,
...
# **putBlogPage**
> BlogPageResponse putBlogPage(blogPageRequest)
...
let blogPageRequest: BlogPageRequest; //

const { status, data } = await apiInstance.putBlogPage(
    blogPageRequest
);
```
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **blogPageRequest** | **BlogPageRequest**|  | |
