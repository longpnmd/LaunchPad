...
|------------- | ------------- | -------------|
|[**deleteGlobal**](#deleteglobal) | **DELETE** /global | |
|[**getGlobal**](#getglobal) | **GET** /global | |
|[**putGlobal**](#putglobal) | **PUT** /global | |
...
const { status, data } = await apiInstance.deleteGlobal();
```
...
const { status, data } = await apiInstance.getGlobal(
    sort,
    paginationWithCount,
    paginationPage,
    paginationPageSize,
...
# **putGlobal**
> GlobalResponse putGlobal(globalRequest)
...
let globalRequest: GlobalRequest; //

const { status, data } = await apiInstance.putGlobal(
    globalRequest
);
```
