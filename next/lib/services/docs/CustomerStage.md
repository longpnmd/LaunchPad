...
**customers** | [**Array&lt;CustomerStageCustomersInner&gt;**](CustomerStageCustomersInner.md) |  | [optional] [default to undefined]
...
```typescript
import { CustomerStage } from './api';

const instance: CustomerStage = {
    id,
    documentId,
    name,
    purpose,
