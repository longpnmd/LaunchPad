...
**permissions** | [**Array&lt;PropertyListedByRolePermissionsInner&gt;**](PropertyListedByRolePermissionsInner.md) |  | [optional] [default to undefined]
...
```typescript
import { PropertyListedByRole } from './api';

const instance: PropertyListedByRole = {
    id,
    documentId,
    name,
    description,
