# TaskRelatedDealStatusCustomersInner
...
**notes** | [**Array&lt;TaskRelatedDealStatusCustomersInnerNotesInner&gt;**](TaskRelatedDealStatusCustomersInnerNotesInner.md) |  | [optional] [default to undefined]
...
```typescript
import { TaskRelatedDealStatusCustomersInner } from './api';

const instance: TaskRelatedDealStatusCustomersInner = {
    id,
    documentId,
    fullName,
    email,
