...
**product** | [**ArticleCategoriesInnerProduct**](ArticleCategoriesInnerProduct.md) |  | [optional] [default to undefined]
**articles** | [**Array&lt;ArticleCategoriesInnerArticlesInner&gt;**](ArticleCategoriesInnerArticlesInner.md) |  | [optional] [default to undefined]
...
```typescript
import { ArticleCategoriesInner } from './api';

const instance: ArticleCategoriesInner = {
    id,
    documentId,
    name,
    product,
