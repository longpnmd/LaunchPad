...
**stage** | [**ClientStageCustomersInnerStage**](ClientStageCustomersInnerStage.md) |  | [optional] [default to undefined]
**deals** | [**Array&lt;ClientStageCustomersInnerDealsInner&gt;**](ClientStageCustomersInnerDealsInner.md) |  | [optional] [default to undefined]
...
```typescript
import { ClientStageCustomersInner } from './api';

const instance: ClientStageCustomersInner = {
    id,
    documentId,
    fullName,
    email,
