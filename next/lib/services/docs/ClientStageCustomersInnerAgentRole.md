# ClientStageCustomersInnerAgentRole
...
**permissions** | [**Array&lt;ClientStageCustomersInnerAgentRolePermissionsInner&gt;**](ClientStageCustomersInnerAgentRolePermissionsInner.md) |  | [optional] [default to undefined]
**users** | [**Array&lt;ArticleCategoriesInnerProductImagesInnerRelatedInner&gt;**](ArticleCategoriesInnerProductImagesInnerRelatedInner.md) |  | [optional] [default to undefined]
...
```typescript
import { ClientStageCustomersInnerAgentRole } from './api';

const instance: ClientStageCustomersInnerAgentRole = {
    id,
    documentId,
    name,
    description,
